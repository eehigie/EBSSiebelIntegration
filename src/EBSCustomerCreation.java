...
public class EBSCustomerCreation {
    ...
    public EBSCustomerCreation() {
        
    }
    
    public EBSCustomerCreation(int user_id,int resp_id, int resp_appl_id, int trx_header_id) {
...
"              );\n"+
     ...
     public static void main(String[] args) {        
        EBSCustomerCreation ecc = new EBSCustomerCreation(1132,50678,222,101);

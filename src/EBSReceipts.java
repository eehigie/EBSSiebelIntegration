...
public class EBSReceipts {
    ...
    private SiebelPropertySet siebelPs;
    
    public int getCustomerId() {
        return customerId;
    }
    
    public  SiebelPropertySet getReceipts(){
        return siebelPs;
    }
    ...
    public void getCustReceipts() throws SQLException {
        ...
        try {
            ...
            while (R.next()){
               ...
               childPS.setProperty("ReceiptNumber", R.getString(1));
               childPS.setProperty("CreationDate", R.getString(2));
               childPS.setProperty("Status", R.getString(3));
               childPS.setProperty("ReceiptType", R.getString(4));
               childPS.setProperty("Currency", R.getString(5));
               childPS.setProperty("Amount", R.getString(6));
               sps.addChild(childPS);
           }
            this.siebelPs = sps;

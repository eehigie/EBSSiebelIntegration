...
public class SiebelCSV {
    ...
    private void WriteSiebelDataToCSV(String PriceListId,String McId, String filePath,SiebelDataBean sdb){
        try {
    ...
    private void UpdateRecordsWithCSVFile(String csvFile, SiebelDataBean sdb) throws SiebelException{
